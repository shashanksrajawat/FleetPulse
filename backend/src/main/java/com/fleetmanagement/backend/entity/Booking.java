...
public class Booking {
    ...
    // The driver assigned to this booking (can be null initially, assigned from
    // pool later)
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    // Estimated time for one-way trip in hours (based on distance and average
    // speed)
    @Column
    ...
    // Total amount to be paid = finalPrice + additionalCharges + taxAmount -
    // discount
    @Column
