...
import com.fleetmanagement.backend.customexception.UserNotFoundException;
...
public class AuthService {
    ...
    public User registerDriver(DriverRegisterRequest request) {
        ...
        driverInfo.setBackgroundVerified(false); // ✅ Added
        driverInfo.setDocumentVerified(false); // ✅ Added
